...
local mappings = {
    ...
    { "<leader>gh", "<cmd>lua MiniDiff.toggle_overlay()<CR>", desc = "preview hunk", nowait = false, remap = false },
    { "<leader>gj", "<cmd>lua MiniDiff.goto_hunk('next')<CR>", desc = "next hunk", nowait = false, remap = false },
    { "<leader>gk", "<cmd>lua MiniDiff.goto_hunk('prev')<CR>", desc = "prev hunk", nowait = false, remap = false },
    ...
    { "<leader>gr", "<cmd>Git reset %<CR>", desc = "reset hunk", nowait = false, remap = false },
    -- { "<leader>gs", "<cmd>lua MiniDiff.do_hunks(0, 'apply')<CR>", desc = "stage hunk", nowait = false, remap = false },
